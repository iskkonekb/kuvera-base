...
namespace kuvera108
{
    public class MyAppUserValidator : UserValidator<ApplicationUser>
    {
        public MyAppUserValidator(ApplicationUserManager mgr)
            : base(mgr)
        {
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        public static ApplicationUserManager Create(IdentityFactoryOptions<ApplicationUserManager> options, IOwinContext context) 
        {
            ...
            manager.UserValidator = new MyAppUserValidator(manager);
