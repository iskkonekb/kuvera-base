...
{
    [Authorize]
    public class ManageController : KuveraController
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.EmailChanged ? "Ваш адрес эл. почты изменен. По почте вам должен прийти запрос на подтверждение регистрации нового ящика"
                : message == ManageMessageId.NoActions ? "Изменений не произведено"
                : "";
        ...
        public async Task<ActionResult> ChangeEmail()
        {
            ...
            var Fullname = claims.FirstOrDefault(c => c.Type == "FullName");
            if (user != null)
            {
